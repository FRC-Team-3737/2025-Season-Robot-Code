...
public class SwerveModuleInfo {
    ...
    public SwerveModuleInfo(int drive_motor_CAN_ID, int angle_motor_CAN_ID, controllerType controller, double max_encoder_voltage, double abs_encoder_max_value, double abs_encoder_value_when_wheel_straight, double x, double y) {

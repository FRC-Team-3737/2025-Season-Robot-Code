...
public class ClawArmPivotExtendCommand extends Command {
    ...
    public ClawArmPivotExtendCommand(SubsystemList subsystems, double angle, double extension, double speed) {
